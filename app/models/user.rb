class User < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :first_name_reading, format: { with: NAME＿READING_REGEX, message: "は全角カタカナで入力して下さい" }
    validates :last_name_reading, format: { with: NAME＿READING_REGEX, message: "は全角カタカナで入力して下さい" }
    validates :birthday
